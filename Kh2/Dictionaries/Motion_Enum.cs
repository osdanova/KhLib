...
{
    /* Mset motions are grouped in 4 versions:
     * Battle with weapon
     * Battle without weapon
     * Non-battle without weapon
     * Non-battle with weapon
     * These tags apply per group. Eg: motions 0,1,2,3 are IDLE in its 4 versions
     */
    public enum Motion_Enum : ushort
    {
        IDLE = 0,
        WALK = 1,
        RUN = 2,
